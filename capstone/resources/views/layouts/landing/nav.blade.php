<div class="tagline-upper text-center text-heading text-shadow mt-5 d-none d-lg-block">SAVE OUR SCHOOL NETWORK</div>
  <div class="tagline-lower text-center text-heading text-expanded text-shadow text-uppercase mb-5 d-none d-lg-block">Defend children's Right to Education!</div>
