        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid w-100" src="img/rius-valle.png" alt="">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid w-100" src="img/sos.png" alt="">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid w-100" src="img/happyskwela.png" alt="">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
          </div>
      ...
      <div class="p-4 my-4" id="portfolio">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-3 featured-block-rounded">
            <a href="#"><figure>
            <img src="img/edwin2.jpg" class="img-fluid" alt="">
            </figure></a> <h5></h5>
            <div class="featured-block-equal-cont"><p></p></div>
          </div>
          <div class="col-md-3 col-sm-3 featured-block-rounded">
            <a href="#"><figure>
            <img src="img/deped-piket.jpg" alt="" class="img-fluid">
            </figure></a> <h5></h5>
            <div class="featured-block-equal-cont"><p></p></div>
          </div>
          <div class="col-md-3 col-sm-3 featured-block-rounded">
            <a href="#"><figure>
            <img src="img/lemlun6.jpg" alt="" class="img-fluid">
            </figure></a> <h5></h5>
            <div class="featured-block-equal-cont"><p></p></div>
          </div>
          <div class="col-md-3 col-sm-3 featured-block-rounded">
            <a href="#"><figure>
            <img src="img/orig.jpg" class="img-fluid" alt="">
            </figure></a> <h5></h5>
            <div class="featured-block-equal-cont"><p></p></div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="update-1">
                ...
                <img src="img/sossos.png" class="img-fluid img1">
