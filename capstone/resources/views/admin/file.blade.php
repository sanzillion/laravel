...
{{--             <div class="col-md-3 text-center fbadge">
              <span class="folder-badge bg-dark">
                <a href="#"><i class="fa fa-times text-red"></i></a>
              </span> 
              <a href="#"><i class="fa fa-folder text-xlg"></i></a>
              <p class="text-xsm">Fuck</p>
            </div> --}}
  ...
  @component('layouts.dashboard.modal')
    ...
    <form action="/file/create" method="POST" enctype="multipart/form-data" id="update">
      ...
      <div class="row">
        ...
        <div class="card">
        <img class="card-img-top" id="filepic" src="{{ asset('/storage/files/test_1507438602.jpg') }}">
        <div class="card-body">
